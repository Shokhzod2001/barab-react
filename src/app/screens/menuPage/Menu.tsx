...
const RestaurantMenu = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        const productSearch: ProductInquiry = {
  ...
  const filteredAndSortedProducts = useMemo(() => {
    ...
    switch (sortBy) {
      case SortOptions.POPULAR:
        filtered.sort((a, b) => (b.productOrders || 0) - (a.productOrders || 0))
        break
      case SortOptions.PRICE_LOW_HIGH:
    ...
    return filtered
  }, [products, selectedTime, selectedSpice, selectedSize, sortBy])
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        {isLoading ? (
          <div className="text-center py-12">
            <div className="text-gray-400 text-lg mb-2">Loading menu...</div>
          </div>
        ) : error ? (
          <div className="text-center py-12">
